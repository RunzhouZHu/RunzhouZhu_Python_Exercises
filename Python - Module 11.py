...
class Book(Publication):
    ...
    def print_information(self):
        print(f"The book name is {self.name}, the author is {self.author}, it has {self.pageCount} pages.")
...
class Magazine(Publication):
    ...
    def print_information(self):
        print(f"The magazine name is {self.name}, the chief editor is {self.chiefEditor}.")
